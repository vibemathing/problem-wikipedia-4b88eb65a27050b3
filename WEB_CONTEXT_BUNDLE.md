...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-4b88eb65a27050b3"
    ],
    "allowed_axioms": [
    ...
    "domain": {
      "description": "Draft source observation in Probability theory; domain extraction is unresolved.",
      "objects": [
    ...
    "problem_id": "problem:wikipedia-4b88eb65a27050b3",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-4b88eb65a27050b3",
        "url": "https://en.wikipedia.org/wiki/Ibragimov%E2%80%93Iosifescu_conjecture_for_%CF%86-mixing_sequences"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Ibragimov–Iosifescu conjecture for φ-mixing sequences",
      "version": 1
    },
    "title": "Ibragimov–Iosifescu conjecture for φ-mixing sequences",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "0b8108f62763b7b8cad4b0d2ec8552f555703a19f7c2be5fe09e06cc71e283a5"
}
```
